 ...
 *
 */
class Candidato_Altera_View extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("Candidato_Altera");
        $ac_v = base64_encode("Candidato_Altera_V");
        $post = $ac;
        ...
        $colunas[1] = $this->form->select("eleicao", $this->traducao->get_leg21(), $idEleicao, $this->descricoes['eleicao'], TRUE, "", "left", "");
        ...
        $colunas[0] = $this->form->texto($this->traducao->get_leg05(), TRUE);
        $colunas[1] = $this->form->select("id_cargo", $this->traducao->get_leg21(), $dados['id_cargo'], $this->descricoes['cargo'], TRUE, "", "left", "");
        ...
        $colunas[1] = $this->form->textfield("nome", $dados['nome'], 50);
