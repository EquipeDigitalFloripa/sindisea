...
class Banner_Altera_Link_View extends View {
 ...
 */
   ...
   public function showView(){
         ...
         ****************INICIO
         */
        $this->traducao->loadTraducao("3062", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         ****************FIM
        ...
        $ac_01      = base64_encode("Banner_Altera_Link");
        $ac_01v     = base64_encode("Arquivo_Altera_Link_V");
        $post       = $ac_01;
      ...
      //  $retorno_nav     .= "&id=".$this->post_request['id'];
        ...
        $tam_tab           = "600"; // tamanho da tabela em px ou em %
        $title_tab         = "Banner: ".$this->descricoes['regiao'][$dados['regiao']];
        $col[0]['color']   = "#FFFFFF";
        $col[0]['nowrap']  = false;
        $col[0]['width']   = "25%";
        $col[1]['color']   = "#EBEBEB";
        ...
        $col[1]['width']   = "75%";
            ...
            */
            ...
            $colunas[1]          = $this->form->textfield("link", $dados['link'], 60);
            Array_push($validacao, $this->form->validar('link','value', '==', '""',$this->traducao->get_leg31(),Array("link"),$this->get_tema(),$this->get_idioma()));
            $lin[0] = $colunas;
