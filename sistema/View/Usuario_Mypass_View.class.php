...
/**
 * View de alteração de Senha do Usuário Corrente
 *
...
class Usuario_Mypass_View extends View {
 ...
 */
   ...
   public function showView(){
         ...
         ****************INICIO
         */
        $this->traducao->loadTraducao("2025", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         ****************FIM
        ...
        $ac_pass     = base64_encode("Usuario_Mypass");
        $ac_passv    = base64_encode("Usuario_Mypass_V");
        $post        = $ac_pass;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
         ...
         */
            ...
            */
            ...
            $colunas[1]          = $this->form->password("senha_atual","",20);
            Array_push($validacao, $this->form->validar('senha_atual','value', '==', '""',$this->traducao->get_leg35(),Array("senha_atual"),$this->get_tema(),$this->get_idioma()));
            $lin[0] = $colunas;
