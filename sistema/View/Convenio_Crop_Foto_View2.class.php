 ...
 *
 */
class Convenio_Crop_Foto_View2 extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("Convenio_Crop_Foto2");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
...
//        $title_tab = "Convenio: $nome_pro ($n_fotos fotos)"; // tï¿½tulo da tabela que lista os itens
        /*
         * ************************************************************************************************************
         * CONFIGURE A LISTA DE ITENS
         * ***************FIM
        ...
        $this->post_request['id'] = $dados['id_convenio'];
