...
/**
 * View de Alteração de dados do Balancete
 *
 ...
 *
 */
class Balancete_Altera_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("5073", $this->get_idioma());
        ...
        $ac = base64_encode("Balancete_Altera");
        $ac_v = base64_encode("Balancete_Altera_V");
        $post = $ac;
...
//        $lin[] = $colunas;
        ...
        $colunas[1] = $this->form->select("mes", $this->traducao->get_leg21(), $mes, $array_meses, TRUE, 'Selecione um mês', "left", "");
        ...
        $colunas[1] = $this->form->textfield("ano", $ano, 20, false, $this->traducao->get_leg24(), null, "left");
        array_push($validacao, $this->form->validar('ano', 'value', '==', '""', $this->traducao->get_leg31(), Array("ano"), $this->get_tema(), $this->get_idioma()));
        $lin[] = $colunas;
