 ...
 *
 */
class CategoriaGaleria_Add_View extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("CategoriaGaleria_Add");
        $ac_v = base64_encode("CategoriaGaleria_Add_V");
        $post = $ac;
        ...
        $colunas[1] = $this->form->textfield("categoria", $this->post_request['categoria'], 50);
        Array_push($validacao, $this->form->validar('categoria', 'value', '==', '""', $this->traducao->get_leg31(), Array("categoria"), $this->get_tema(), $this->get_idioma()));
        $lin[0] = $colunas;
