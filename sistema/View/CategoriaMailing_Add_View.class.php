 ...
 *
 */
class CategoriaMailing_Add_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("3005", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac = base64_encode("CategoriaMailing_Add");
        $ac_v = base64_encode("CategoriaMailing_Add_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
