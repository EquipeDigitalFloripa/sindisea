...
class Usuario_Pass_View extends View {
 ...
 */
   ...
   public function showView(){
         ...
         ****************INICIO
         */
        $this->traducao->loadTraducao("2021", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         ****************FIM
        ...
        $ac_pass     = base64_encode("Usuario_Pass");
        $ac_passv    = base64_encode("Usuario_Pass_V");
        $post        = $ac_pass;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
