 ...
 *
 */
class TipoMovimentacao_Add_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("5086", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac = base64_encode("TipoMovimentacao_Add");
        $ac_v = base64_encode("TipoMovimentacao_Add_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        $colunas[1] = $this->form->select("rd", false, 'r', array('r' => 'Receita', 'd' => 'Despesa'), "left", "", "", false, "", "");
        $lin[] = $colunas;
