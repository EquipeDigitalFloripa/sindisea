 ...
 *
 */
class TipoMovimentacao_Altera_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("5088", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac_01 = base64_encode("TipoMovimentacao_Altera");
        $ac_01v = base64_encode("TipoMovimentacao_Altera_V");
        $post = $ac_01;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        $colunas[1] = $this->form->select("rd", false, $dados['rd'], array('r' => 'Receita', 'd' => 'Despesa'), "left", "", "", false, "", "");
        $lin[] = $colunas;
