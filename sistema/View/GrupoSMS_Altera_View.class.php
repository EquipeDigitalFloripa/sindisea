...
/**
 * View de alteração de dados do GrupoSMS
 *
 ...
 * @package View
 */
class GrupoSMS_Altera_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("4012", $this->get_idioma());
        ...
        $ac = base64_encode("GrupoSMS_Altera");
        $ac_v = base64_encode("GrupoSMS_Altera_V");
        ...
        $colunas[1] = $this->form->textfield("descricao_grupo_sms", $dados['descricao_grupo_sms']);
