 ...
 *
 */
class Gestao_Gerencia_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("5052", $this->get_idioma());
         ...
         */
        $co = base64_encode("Gestao_Control"); // CONTROLLER
        $ac = base64_encode("Gestao_Gerencia");
        $ac_apaga = base64_encode("Gestao_Apaga");
        $ac_ativa = base64_encode("Gestao_Ativa");
        $ac_desativa = base64_encode("Gestao_Desativa");
        $ac_altera = base64_encode("Gestao_Altera_V");
        $ac_destacar = base64_encode("Gestao_Destaque");
        $ac_rev_destacar = base64_encode("Gestao_Reverter_Destaque");
        ...
        $campos[1]["texto"] = $this->traducao->get_leg05(); //alterar

        $campos[2]["tamanho_celula"] = "15%";
        $campos[2]["texto"] = $this->traducao->get_leg02(); //alterar

        $campos[3]["tamanho_celula"] = "15%";
        $campos[3]["texto"] = $this->traducao->get_leg03(); //ativar/desativar

        $campos[4]["tamanho_celula"] = "15%";
        $campos[4]["texto"] = $this->traducao->get_leg04(); //apagar
        ...
        while ($i < count($this->objetos)) {
            ...
            $status = $dados['status_gestao'] == "A" ? "Ativo" : ($dados['status_gestao'] == "I" ? "Inativo" : ($dados['status_gestao'] == "D" ? "Apagado" : ""));
            ...
            $modais[3]['campos'] = Array('ac' => $ac_destacar);
            $modais[3]['acao'] = "destacar_gestao";
            $modais[3]['msg'] = $this->traducao->get_leg34();

            $modais[4]['campos'] = Array('ac' => $ac_rev_destacar);
            $modais[4]['acao'] = "reverter_destacar";
             ...
             */
            if ($dados['status_gestao'] == "A") {
                $ad = "
                    <span class=\"texto_conteudo_tabela\">
                        <a href=\"javascript:certeza_2(" . $dados['id_gestao'] . ")\">
                ...
                $ad = "
                    <span class=\"texto_conteudo_tabela\">
                        <a href=\"javascript:certeza_1(" . $dados['id_gestao'] . ")\">
            ...
            if ($dados['destaque_gestao'] == "1") {
                $destaq = "<span class=\"texto_conteudo_tabela\">
                                <a href=\"javascript:certeza_4(" . $dados['id_gestao'] . ")\">
                ...
                $destaq = "<span class=\"texto_conteudo_tabela\">
                                <a href=\"javascript:certeza_3(" . $dados['id_gestao'] . ")\">
            ...
            $colunas[0]["texto"] = "Nome da Gestão: <strong><font size=\"2\" color=\"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . $dados['desc_gestao'] . "</font></strong><br>  
                                    Cadastrado em: <font size=\"2\" color=\"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . $this->dat->get_dataFormat('BD', $dados['data_cadastro_gestao'], 'DMA') . "</font><br>
                                    ";
            
            
            $colunas[1]["alinhamento"] = "center";
            $colunas[1]["texto"] = $destaq;

            $colunas[2]["alinhamento"] = "center";
            $colunas[2]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                        <a href=\"javascript:submit_campo(" . $dados['id_gestao'] . ",'$ac_altera');\">
            ...
            $colunas[4]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                        <a href=\"javascript:certeza_0(" . $dados['id_gestao'] . ")\">
