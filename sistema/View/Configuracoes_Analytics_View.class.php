...
class Configuracoes_Analytics_View extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("Configuracoes_Analytics");
        ...
        $colunas[1] = $this->form->textarea("analytics", $dados['analytics'], 90, 20, FALSE, '', FALSE, '');
        $lin[] = $colunas;
