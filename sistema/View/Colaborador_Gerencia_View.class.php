 ...
 *
 */
class Colaborador_Gerencia_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("5032", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac_apaga = base64_encode("Colaborador_Apaga");
        $ac_ativa = base64_encode("Colaborador_Ativa");
        $ac_desativa = base64_encode("Colaborador_Desativa");
        $ac_altera = base64_encode("Colaborador_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        $filtros['pesquisa']["texto"] = $this->traducao->get_titulo_formulario07(); // legenda ao lado do campo
        ...
        while ($i < count($this->objetos)) {
             ...
             * ***************INICIO
             */
            if ($dados['status_colaborador'] == "A") {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(" . $dados['id_colaborador'] . ")\">
                                                <img src=\"temas/" . $this->get_tema() . "/icones/ativar.png\" width=\"25\" height=\"25\" align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg13() . "
                                            </a>
                                            </span>";
            } else {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(" . $dados['id_colaborador'] . ")\">
                                                <img src=\"temas/" . $this->get_tema() . "/icones/desativar.png\" width=\"25\" height=\"25\" align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg14() . "
                                            </a>
                                            </span>";
            }
            /*
            ...
            $colunas[0]["texto"] = "
                <a title=\"Foto do Colaborador: " . $dados['nome'] . "\"href=\"$diretorio" . $dados['foto'] . "." . $dados['ext_foto'] . "\" rel=\"lightbox[roadtrip]\">
                  <img src=\"../sys/includes/make_thumb.php?ts=" . time() . "&diretorio=../arquivos/img_colaborador/&arquivo=" . $nome . "&tamanho=70 \" border=\"0\" />
                </a>";

            $colunas[1]["alinhamento"] = "left";
            $colunas[1]["texto"] = "<strong><font size=\"1\" color = \"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                    " . $dados['nome'] . "</strong></font>";

            $colunas[2]["alinhamento"] = "left";
            $colunas[2]["texto"] = "<strong><font size=\"1\" color = \"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                    " . $this->descricoes['gestao'][$dados['id_gestao']] . "</strong></font>";

            $colunas[3]["alinhamento"] = "center";
            $colunas[3]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(" . $dados['id_colaborador'] . ",'$ac_altera');\">
                                                <img src=\"temas/" . $this->get_tema() . "/icones/dados.png\" width=\"20\" height=\"20\"  align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg11() . "
                                            </a>
                                            </span>";
            ...
            $colunas[5]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(" . $dados['id_colaborador'] . ")\">
                                                <img src=\"temas/" . $this->get_tema() . "/icones/del.png\" width=\"15\" height=\"15\" align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg15() . "
                                            </a>
                                            </span>";
