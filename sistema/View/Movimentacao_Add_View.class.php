 ...
 *
 */
class Movimentacao_Add_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("5089", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac = base64_encode("Movimentacao_Add");
        $ac_v = base64_encode("Movimentacao_Add_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        Array_push($validacao, $this->form->validar('tipo_movimentacao', 'value', '==', '"0"', $this->traducao->get_leg34(), Array("tipo_movimentacao"), $this->get_tema(), $this->get_idioma()));
        ...
        Array_push($validacao, $this->form->validar('id_centro', 'value', '==', '"0"', $this->traducao->get_leg32(), Array("id_centro"), $this->get_tema(), $this->get_idioma()));

        $lin[] = $colunas;
        
        /* DATA COMPETÊNCIA */
        $colunas[0] = $this->form->texto($this->traducao->get_leg02(), true);
        $colunas[1] = $this->form->textfield("data", $this->dat->get_dataFormat("NOW", "", "DMA"), 10, false, "", null, "left");
        array_push($validacao, $this->form->validar('data', 'value', '==', '""', $this->traducao->get_leg31(), Array("data"), $this->get_tema(), $this->get_idioma()));
        $lin[] = $colunas;

        //  descrição
        $colunas[0] = $this->form->texto($this->traducao->get_leg03(), true);
        $colunas[1] = $this->form->textfield("descricao", "", 60, false, "", null, "left");
        ...
        $colunas[1] = $this->form->textfield("valor_mov", "0,00", 20, TRUE, "", null, "left", "onKeyPress=\"return(formataMoeda(this,'.',',',event))\"", "");
        $lin[] = $colunas;
