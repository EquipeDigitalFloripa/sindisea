...
/**
 * View de Inclusão de Categoria de Posts
 *
 ...
 *
 */
class Gestao_Add_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("5051", $this->get_idioma());
        ...
        $ac = base64_encode("Gestao_Add");
        $ac_v = base64_encode("Gestao_Add_V");
        $post = $ac;
        ...
        $colunas[1] = $this->form->textfield("desc_gestao", "", 50, TRUE, $this->traducao->get_leg21(), null, "left", "", "");
        Array_push($validacao, $this->form->validar('desc_gestao', 'value', '==', '""', $this->traducao->get_leg32(), Array("desc_gestao"), $this->get_tema(), $this->get_idioma()));
        $lin[] = $colunas;
