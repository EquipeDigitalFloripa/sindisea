 ...
 *
 */
class CategoriaGaleria_Gerencia_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("3044", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac_apaga = base64_encode("CategoriaGaleria_Apaga");
        $ac_ativa = base64_encode("CategoriaGaleria_Ativa");
        $ac_desativa = base64_encode("CategoriaGaleria_Desativa");
        $ac_altera = base64_encode("CategoriaGaleria_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
