...
class Usuario_Add_View extends View {
 ...
 */
   ...
   public function showView(){
         ...
         ****************INICIO
         */
        $this->traducao->loadTraducao("2024", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         ****************FIM
        ...
        $ac          = base64_encode("Usuario_Add");
        $ac_v        = base64_encode("Usuario_Add_V");
        $post        = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
      ...
      //  $retorno_nav     .= "&id=".$this->post_request['id'];
         ...
         */
            ...
            */
            ...
            $colunas[1]          = $this->form->textfield("nome_usuario");
            ...
            $colunas[1]          = $this->form->select("perm_usuario",$this->traducao->get_leg21(),"",$this->descricoes['desc_perm_usuario']);
            ...
            $colunas[1]          = $this->form->AJAX_existe_registro("login_usuario","",20,true,"O nome não pode conter mais que 16 caracteres",$this->traducao->get_leg27(),20);
            ...
            $colunas[1]          = $this->form->password("senha_usuario","",20,true,$this->traducao->get_leg26());
            Array_push($validacao, $this->form->validar('senha_usuario','value', '==', '""',$this->traducao->get_leg37(),Array("senha_usuario"),$this->get_tema(),$this->get_idioma()));
            Array_push($validacao, $this->form->validar('senha_usuario','value.length', '<', '3',$this->traducao->get_leg37(),Array("senha_usuario"),$this->get_tema(),$this->get_idioma()));
            $lin[3] = $colunas;

            $colunas[0]          = $this->form->texto($this->traducao->get_leg04(),true);
            $colunas[1]          = $this->form->textfield("email_usuario");
            ...
            $colunas[1]          = $this->form->textfield("endereco_usuario","",80);
            $lin[5] = $colunas;


            $colunas[0]          = $this->form->texto($this->traducao->get_leg06(),false);
            $colunas[1]          = $this->form->textfield("bairro_usuario","",60);
            $lin[6] = $colunas;


            $colunas[0]          = $this->form->texto($this->traducao->get_leg07(),false);
            $colunas[1]          = $this->form->textfield("complemento_end_usuario","",60);
            $lin[7] = $colunas;

            $colunas[0]          = $this->form->texto($this->traducao->get_leg08(),false);
            $colunas[1]          = $this->form->textfield("cep_usuario","",20);
            $lin[8] = $colunas;

            $colunas[0]          = $this->form->texto($this->traducao->get_leg09(),true);
            $colunas[1]          = $this->form->textfield("cidade_usuario");
            ...
            $colunas[1]          = $this->form->textfield("pais_residencia_usuario");
            ...
            $colunas[1]          = $this->form->textfield("telefone_usuario");
            $lin[11] = $colunas;

            $colunas[0]          = $this->form->texto($this->traducao->get_leg12(),false);
            $colunas[1]          = $this->form->textfield("website_usuario");
            $lin[12] = $colunas;
