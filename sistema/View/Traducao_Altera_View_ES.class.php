...
class Traducao_Altera_View_ES extends View {
 ...
 */
   ...
   public function showView(){
         ...
         ****************INICIO
         */
        $this->traducao->loadTraducao("2014", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         ****************FIM
        ...
        $ac_01       = base64_encode("Traducao_Altera_ES");
        $post        = $ac_01;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
      ...
      $col[0]['nowrap']  = false;
         ...
         */
            ...
            $dadoses  = $this->objetos[1]->get_all_dados();
            ...
            // aplica regra de recebimento no array de dados
            foreach ($dadoses as $chave => $valor){
                $dadoses[$chave] = stripslashes($valor);
            }
           /*
             * ******************************************************************************************
           ...
           $lin       = Array();
            ...
            $colunas[1]          = "<h2 style=\"text-align:center;\"><strong>".$dadoses['nome_arquivo']."</strong></h2>";
            $colunas[2]          = "";
            $lin[1] = $colunas;

            $colunas[0]          = $this->form->texto("Lingua :",false);
            $colunas[1]          = "<h2 style=\"text-align:center;\"><strong>PORTUGUÊS</strong></h2>";
            $colunas[2]          = '<h2 style="text-align:center;"><strong>ESPANHOL</strong></h2>';
            $lin[2] = $colunas;
            ...
            $colunas[2]          = $this->form->textarea_resize("titulo_formulario01",$dadoses['titulo_formulario01'],70,1);
            $lin[3] = $colunas;
            ...
            $colunas[2]          = $this->form->textarea_resize("titulo_formulario02",$dadoses['titulo_formulario02'],70,1);
            $lin[4] = $colunas;
            ...
            $colunas[2]          = $this->form->textarea_resize("titulo_formulario03",$dadoses['titulo_formulario03'],70,1);
            $lin[5] = $colunas;
            ...
            $colunas[2]          = $this->form->textarea_resize("titulo_formulario04",$dadoses['titulo_formulario04'],70,1);
            $lin[6] = $colunas;
            ...
            $colunas[2]          = $this->form->textarea_resize("titulo_formulario05",$dadoses['titulo_formulario05'],70,1);
            $lin[7] = $colunas;
            ...
            $colunas[2]          = $this->form->textarea_resize("titulo_formulario06",$dadoses['titulo_formulario06'],70,1);
            $lin[8] = $colunas;
