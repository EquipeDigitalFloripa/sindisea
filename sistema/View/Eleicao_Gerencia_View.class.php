 ...
 *
 */
class Eleicao_Gerencia_View extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("Eleicao_Gerencia");
        $ac_apaga = base64_encode("Eleicao_Apaga");
        $ac_ativa = base64_encode("Eleicao_Ativa");
        $ac_desativa = base64_encode("Eleicao_Desativa");
        $ac_altera = base64_encode("Eleicao_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        while ($i < count($this->objetos)) {
             ...
             * ***************INICIO
             */
            if ($dados['status_eleicao'] == "A") {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(" . $dados['id_eleicao'] . ")\">
                ...
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(" . $dados['id_eleicao'] . ")\">
            ...
            $colunas[1]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                            " . $this->dat->get_dataFormat("BD", $dados['data_inicio'], "DMA") . "
                                    </span>
                                                ";

            $colunas[2]["alinhamento"] = "center";
            $colunas[2]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                            " . $this->dat->get_dataFormat("BD", $dados['data_fim'], "DMA") . "
                                    </span>
                                                ";
            ...
            $colunas[3]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(" . $dados['id_eleicao'] . ",'$ac_altera');\">
            ...
            $colunas[5]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(" . $dados['id_eleicao'] . ")\">
