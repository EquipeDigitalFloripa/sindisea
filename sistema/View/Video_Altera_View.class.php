...
/**
 * View de Alteração de dados do Video
 *
 ...
 *
 */
class Video_Altera_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("5007", $this->get_idioma());
        ...
        $ac = base64_encode("Video_Altera");
        $ac_v = base64_encode("Video_Altera_V");
        $post = $ac;
...
//            $dados[$chave] = htmlspecialchars(stripslashes($valor), NULL, "ISO-8859-1");
        ...
        $colunas[1] = $this->form->textfield("titulo_video", $dados['titulo_video'], 70, TRUE, $this->traducao->get_leg21(), null, "left", "", "");
        ...
        $colunas[1] = $this->form->textfield("iframe_video", htmlentities($dados['iframe_video']), 70, TRUE, $this->traducao->get_leg21(), null, "left", "", "");
        ...
        $colunas[1] = $this->form->textarea("texto_video", $dados['texto_video'], 80, 5, true, 500, true, $this->traducao->get_leg23(), "left");
        $lin[] = $colunas;
