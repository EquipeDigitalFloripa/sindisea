 ...
 *
 */
class CategoriaGaleria_Altera_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("3045", $this->get_idioma());
         ...
         * ***************INICIO
         */
        $co = base64_encode("CategoriaGaleria_Control"); // CONTROLLER
        $ac = base64_encode("CategoriaGaleria_Gerencia");
        $ac_01 = base64_encode("CategoriaGaleria_Altera");
        $ac_01v = base64_encode("CategoriaGaleria_Altera_V");
        $post = $ac_01;
        ...
        $colunas[1] = $this->form->textfield("nome_categoria", $dados['nome_categoria']);
        Array_push($validacao, $this->form->validar('nome_categoria', 'value', '==', '""', $this->traducao->get_leg31(), Array("nome_categoria"), $this->get_tema(), $this->get_idioma()));
        $lin[0] = $colunas;
