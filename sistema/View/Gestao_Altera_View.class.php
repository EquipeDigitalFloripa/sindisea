 ...
 *
 */
class Gestao_Altera_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("5053", $this->get_idioma());
        ...
        $ac = base64_encode("Gestao_Altera");
        $ac_v = base64_encode("Gestao_Altera_V");
        $post = $ac;
        ...
        $colunas[1] = $this->form->textfield("desc_gestao", $dados['desc_gestao']);
