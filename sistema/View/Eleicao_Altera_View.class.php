...
class Eleicao_Altera_View extends View {
    ...
    public function showView(){
        ...
        $ac_01       = base64_encode("Eleicao_Altera");
        $ac_01v      = base64_encode("Eleicao_Altera_V");
        $post        = $ac_01;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        $colunas[1]          = $this->form->textfield("descricao",$dados['descricao'],50);
        ...
        $colunas[1] = $this->form->textfield("data_inicio",$this->dat->get_dataFormat("BD", $dados['data_inicio'], "DMA"),50);
        ...
        $colunas[1] = $this->form->textfield("data_fim",$this->dat->get_dataFormat("BD", $dados['data_fim'], "DMA"),50);
