 ...
 *
 */
class CategoriaNoticia_Add_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("4035", $this->get_idioma());
        ...
        $ac = base64_encode("CategoriaNoticia_Add");
        $ac_v = base64_encode("CategoriaNoticia_Add_V");
        $post = $ac;
        ...
        $colunas[1] = $this->form->textfield("desc_categoria_noticia", "", 50, TRUE, $this->traducao->get_leg21(), null, "left", "", "");
