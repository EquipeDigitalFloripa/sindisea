 ...
 *
 */
class RelatorioAssociado_Endereco_View extends View {
    ...
    public function showView() {
        ...
        $ac_imprimir = base64_encode("Imprimir_Relatorioa_Endereco");    
        ...
        $title_tab = 'Lista de Filiados Endereço - ' . $this->total_reg;
        ...
        $campos[2]["texto"] = "Endereço"; //$this->traducao->get_leg03();

        $campos[3]["tamanho_celula"] = "15%";
        $campos[3]["texto"] = "Bairro"; //$this->traducao->get_leg04();

        $campos[4]["tamanho_celula"] = "15%";
        $campos[4]["texto"] = "Cidade"; //$this->traducao->get_leg05();
        ...
        while ($i < count($this->objetos)) {
            ...
            $colunas[2]["texto"] = '<font size="1" color="003399" face="Verdana, Arial, Helvetica, sans-serif">' . $dados['endereco'] . ', ' . $dados['numero'] . ' - ' . $dados['complemento'] . '</font>';

            $colunas[3]["alinhamento"] = "left";
            $colunas[3]["texto"] = '<font size="1" color="003399" face="Verdana, Arial, Helvetica, sans-serif">' . $dados['bairro'] . '</font>';
            
            $colunas[4]["alinhamento"] = "left";
            $colunas[4]["texto"] = '<font size="1" color="003399" face="Verdana, Arial, Helvetica, sans-serif">' . $dados['cidade'] . ' / ' . $dados['estado'] . '</font>';
                ...
                var imprimir = function(){
                    ...
                    $.ajax({                                    
                        ...
                        success: function (data) {   
                            window.open("../sys/arquivos/fileRelatorioEndereco.pdf", "_blank");
                        }
                    });
                };
