...
/**
 * View de alteração de dados do Aviso
 *
 ...
 * @package View
 */
class ContatoSMS_Altera_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("4007", $this->get_idioma());
        ...
        $ac = base64_encode("ContatoSMS_Altera");
        $ac_v = base64_encode("ContatoSMS_Altera_V");
        ...
        $colunas[1] = $this->form->select("id_grupo_sms", "Selecione", $dados['id_grupo_sms'], $this->descricoes['desc_grupo_sms'], $align = "left", "", "", false, "");
        ...
        $colunas[1] = $this->form->textfield("nome_contato", $dados['nome_contato']);
        $lin[] = $colunas;
        ...
        $colunas[1] = $this->form->textfield("telefone_contato", $dados['telefone_contato']);
