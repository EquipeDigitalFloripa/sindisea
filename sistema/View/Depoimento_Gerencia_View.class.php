...
/**
 * View de Gerenciamento dos Depoimentos
 *
 ...
 *
 */
class Depoimento_Gerencia_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("4062", $this->get_idioma());
        ...
        $ac = base64_encode("Depoimento_Gerencia");
        $ac_apaga = base64_encode("Depoimento_Apaga");
        $ac_ativa = base64_encode("Depoimento_Ativa");
        $ac_desativa = base64_encode("Depoimento_Desativa");
        $ac_altera = base64_encode("Depoimento_Altera_V");
        $post = $ac;
        ...
        $campos[2]["texto"] = $this->traducao->get_leg03(); //ativar/desativar

        $campos[3]["tamanho_celula"] = "20%";
        $campos[3]["texto"] = $this->traducao->get_leg04(); //apagar
        ...
        while ($i < count($this->objetos)) {
             ...
             */
            if ($dados['status_depoimento'] == "A") {
                $ad = "
                    <span class=\"texto_conteudo_tabela\">
                        <a href=\"javascript:certeza_2(" . $dados['id_depoimento'] . ")\">
                ...
                $ad = "
                    <span class=\"texto_conteudo_tabela\">
                        <a href=\"javascript:certeza_1(" . $dados['id_depoimento'] . ")\">
            ...
            $colunas[0]["texto"] = "Data: <strong><font size=\"2\" color=\"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . $this->dat->get_dataFormat('BD', $dados['data_depoimento'], 'DMA') . "</font></strong><br><br>
                                    Nome: <strong><font size=\"2\" color=\"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . $dados['nome_depoimento'] . "</font></strong><br><br>
                                    Depoimento: <font size=\"2\" color=\"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . $dados['texto_depoimento'] . "</font>";

            $colunas[1]["alinhamento"] = "center";
            $colunas[1]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                        <a href=\"javascript:submit_campo(" . $dados['id_depoimento'] . ",'$ac_altera');\">
            ...
            $colunas[3]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                        <a href=\"javascript:certeza_0(" . $dados['id_depoimento'] . ")\">
