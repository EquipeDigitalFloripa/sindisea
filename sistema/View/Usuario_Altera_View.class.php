 ...
 *
 */
class Usuario_Altera_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("2022", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac_01 = base64_encode("Usuario_Altera");
        $ac_01v = base64_encode("Usuario_Altera_V");
        $post = $ac_01;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        $colunas[1] = $this->form->AJAX_existe_registro("login_usuario", $dados['login_usuario'], 20, true, "O nome não pode conter mais que 16 caracteres", $this->traducao->get_leg27(), 20);
