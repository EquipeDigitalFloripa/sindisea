 ...
 *
 */
class Convenio_Gerencia_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("5062", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac_apaga = base64_encode("Convenio_Apaga");
        $ac_ativa = base64_encode("Convenio_Ativa");
        $ac_desativa = base64_encode("Convenio_Desativa");
        $ac_altera = base64_encode("Convenio_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        while ($i < count($this->objetos)) {
             ...
             * ***************INICIO
             */
            if ($dados['status_convenio'] == "A") {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(" . $dados['id_convenio'] . ")\">
                ...
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(" . $dados['id_convenio'] . ")\">
            ...
            $diretorio = "../sys/arquivos/img_convenio/";
            if ($dados['ext_foto']) {
            ...
            $colunas[0]["texto"] = "
                <a title=\"Foto do Convenio: " . $dados['nome'] . "\"href=\"$diretorio" . $dados['foto'] . "." . $dados['ext_foto'] . "\" rel=\"lightbox[roadtrip]\">
                  <img src=\"../sys/includes/make_thumb.php?ts=" . time() . "&diretorio=../arquivos/img_convenio/&arquivo=" . $nome . "&tamanho=70 \" border=\"0\" />
                </a>";
            ...
            $colunas[2]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(" . $dados['id_convenio'] . ",'$ac_altera');\">
            ...
            $colunas[4]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(" . $dados['id_convenio'] . ")\">
