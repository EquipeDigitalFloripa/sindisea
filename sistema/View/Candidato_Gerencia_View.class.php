 ...
 *
 */
class Candidato_Gerencia_View extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("Candidato_Gerencia");
        $ac_apaga = base64_encode("Candidato_Apaga");
        $ac_ativa = base64_encode("Candidato_Ativa");
        $ac_desativa = base64_encode("Candidato_Desativa");
        $ac_altera = base64_encode("Candidato_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        $campos[5]["texto"] = $this->traducao->get_leg04();

        $campos[6]["tamanho_celula"] = "10%";
        $campos[6]["texto"] = $this->traducao->get_leg04();
        ...
        while ($i < count($this->objetos)) {
             ...
             * ***************INICIO
             */
            if ($dados['status_candidato'] == "A") {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(" . $dados['id_candidato'] . ")\">
                                                <img src=\"temas/" . $this->get_tema() . "/icones/desativar.png\" width=\"25\" height=\"25\" align=\"left\" border=\"0\" hspace=\"2\"> " . $this->traducao->get_leg13() . "
                                            </a>
                                            </span>";
            } else {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(" . $dados['id_candidato'] . ")\">
                                                <img src=\"temas/" . $this->get_tema() . "/icones/ativar.png\" width=\"25\" height=\"25\" align=\"left\" border=\"0\" hspace=\"2\"> " . $this->traducao->get_leg14() . "
                                            </a>
                                            </span>";
            }
            /*
            ...
            $colunas[4]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(" . $dados['id_candidato'] . ",'$ac_altera');\">
            ...
            $colunas[5]["texto"] = $ad; // leg 13 e leg 14

            $colunas[6]["alinhamento"] = "center";
            $colunas[6]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(" . $dados['id_candidato'] . ")\">
