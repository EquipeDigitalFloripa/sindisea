 ...
 *
 */
class Balancete_Gerencia_View extends View {
    ...
    public function showView() {
         ...
         * ***************INICIO
         */
        $this->traducao->loadTraducao("5072", $this->get_idioma());
        /*
         * ************************************************************************************************************
         * CONFIGURE O ID DE TRADUCAO DA VIEW
         * ***************FIM
        ...
        $ac = base64_encode("Balancete_Gerencia");
        $ac_apaga = base64_encode("Balancete_Apaga");
        $ac_ativa = base64_encode("Balancete_Ativa");
        $ac_desativa = base64_encode("Balancete_Desativa");
        $ac_altera = base64_encode("Balancete_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
...
//        $campos[2]["texto"] = $this->traducao->get_leg03();
        ...
        while ($i < count($this->objetos)) {
             ...
             * ***************INICIO
             */
            if ($dados['status_balancete'] == "A") {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(" . $dados['id_balancete'] . ")\">
                ...
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(" . $dados['id_balancete'] . ")\">
            ...
            $diretorio = "../sys/arquivos/arquivo_balancete/balancete_".$dados['id_balancete']."/";

            $colunas[0]["alinhamento"] = "center";
            $colunas[0]["texto"] = "<strong><font size=\"1\" color = \"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">
                    " . $this->dat->get_dataFormat('BD', $dados['data'], 'DMA') . "</font></strong>
                        ";
            
            $colunas[1]["alinhamento"] = "left";
            $colunas[1]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"".$diretorio . $dados['completo']."\" download>
                                                <img src=\"temas/" . $this->get_tema() . "/icones/pdf.png\" width=\"25\" height=\"25\"  align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg12() . "
                                            </a>
                                            </span>";
...
//            $colunas[2]["texto"] = "
//                                            <span class=\"texto_conteudo_tabela\">
//                                            <a href=\"".$diretorio . $dados['movimento_caixa']."\" download>
//                                                <img src=\"temas/" . $this->get_tema() . "/icones/pdf.png\" width=\"25\" height=\"25\"  align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg12() . "
//                                            </a>
//                                            </span>";
            ...
            $colunas[2]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"".$diretorio . $dados['resumido']."\" download>
                                                <img src=\"temas/" . $this->get_tema() . "/icones/pdf.png\" width=\"25\" height=\"25\"  align=\"center\" border=\"0\" hspace=\"2\"><br>" . $this->traducao->get_leg12() . "
                                            </a>
                                            </span>";
            ...
            $colunas[3]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(" . $dados['id_balancete'] . ",'$ac_altera');\">
            ...
            $colunas[5]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(" . $dados['id_balancete'] . ")\">
