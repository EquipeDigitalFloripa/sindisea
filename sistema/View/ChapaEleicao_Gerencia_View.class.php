 ...
 *
 */
class ChapaEleicao_Gerencia_View extends View {
    ...
    public function showView() {
        ...
        $ac = base64_encode("ChapaEleicao_Gerencia");
        $ac_apaga = base64_encode("ChapaEleicao_Apaga");
        $ac_ativa = base64_encode("ChapaEleicao_Ativa");
        $ac_desativa = base64_encode("ChapaEleicao_Desativa");
        $ac_altera = base64_encode("ChapaEleicao_Altera_V");
        $post = $ac;
        /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
        ...
        while ($i < count($this->objetos)) {
             ...
             * ***************INICIO
             */
            if ($dados['status_chapa_eleicao'] == "A") {
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(" . $dados['id_chapa_eleicao'] . ")\">
                ...
                $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(" . $dados['id_chapa_eleicao'] . ")\">
            ...
            $colunas[1]["texto"] = "<span class=\"texto_conteudo_tabela\">
                                            " . $this->descricoes['eleicao'][$dados['id_eleicao']] . "
                                    </span>
                                                ";
            ...
            $colunas[2]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(" . $dados['id_chapa_eleicao'] . ",'$ac_altera');\">
            ...
            $colunas[4]["texto"] = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(" . $dados['id_chapa_eleicao'] . ")\">
