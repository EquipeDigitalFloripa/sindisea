...
class CategoriaNoticia_Gerencia_View extends View {
    ...
    public function showView() {
        ...
        while ($i < count($this->objetos)) {
            ...
            $colunas[0]["texto"] = "Tipo da Notícia: <font size=\"2\" color=\"#003399\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . $this->descricoes['tipo_noticia'][$dados['id_tipo_noticia']] . "</font><br>
