 ...
 *
 */
class ChapaEleicao_Altera_View extends View {
    ...
    public function showView() {
        ...
        $ac_01 = base64_encode("ChapaEleicao_Altera");
        $ac_01v = base64_encode("ChapaEleicao_Altera_V");
        $post = $ac_01;
        ...
        $colunas[1] = $this->form->select("id_eleicao", $this->traducao->get_leg21(), $dados['id_eleicao'], $this->descricoes['eleicao'], TRUE, 'Escolha uma eleição para a Chapa', "left", "");
