...
/**
 * View de Inclusão de Depoimentos
 *
 ...
 *
 */
class Depoimento_Add_View extends View {
    ...
    public function showView() {
         ...
         */
        $this->traducao->loadTraducao("4061", $this->get_idioma());
        ...
        $ac = base64_encode("Depoimento_Add");
        $ac_v = base64_encode("Depoimento_Add_V");
        $post = $ac;
        ...
        $colunas[1] = $this->form->textfield("nome_depoimento", "", 70, TRUE, $this->traducao->get_leg21(), null, "left", "", "");
        Array_push($validacao, $this->form->validar('nome_depoimento', 'value', '==', '""', $this->traducao->get_leg31(), Array("nome_depoimento"), $this->get_tema(), $this->get_idioma()));
        $lin[] = $colunas;
        
        $colunas[0] = $this->form->texto($this->traducao->get_leg02(), TRUE);
        $colunas[1] = $this->form->textarea("texto_depoimento", "", 80, 5, true, 500, true, $this->traducao->get_leg23(), "left");
