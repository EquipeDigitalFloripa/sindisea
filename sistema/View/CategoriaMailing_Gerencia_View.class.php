...
class CategoriaMailing_Gerencia_View extends View{
 ...
 */
   ...
   public function showView(){
        ...
        $ac_apaga     = base64_encode("CategoriaMailing_Apaga");
        $ac_ativa     = base64_encode("CategoriaMailing_Ativa");
        $ac_desativa = base64_encode("CategoriaMailing_Desativa");
        $ac_altera    = base64_encode("CategoriaMailing_Altera_V");
        $post = $ac;
       /*
         * ************************************************************************************************************
         * CONFIGURE AS POSSIVEIS ACOES
...
*/
        ...
        while ($i < count($this->objetos)) {
           ...
           /*
             ...
             ****************INICIO
            */
                if($dados['status_tipo_mailing'] == "A"){
                    $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_2(".$dados['tipo_mailing'].")\">
                    ...
                    $ad = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_1(".$dados['tipo_mailing'].")\">
            ...
            */
            ...
            $colunas[0]["texto"]       = "
                                            ".$dados['desc_tipo_mailing']."";

            $colunas[1]["alinhamento"] = "justify";
            $colunas[1]["texto"]       = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:submit_campo(".$dados['tipo_mailing'].",'$ac_altera');\">
            ...
            $colunas[3]["texto"]       = "
                                            <span class=\"texto_conteudo_tabela\">
                                            <a href=\"javascript:certeza_0(".$dados['tipo_mailing'].")\">
