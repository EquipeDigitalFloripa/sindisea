...
/**
 * DAO da entidade Depoimento, acessa todas as operações de banco de dados referentes ao Model Depoimento que está em Libs
 *
 ...
 *
 */
class Depoimento_DAO extends Generic_DAO {

    public $chave = 'id_depoimento';
    public $tabela = 'tb_depoimento';
