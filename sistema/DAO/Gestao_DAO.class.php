...
/**
 * DAO da entidade Gestao, acessa todas as operações de banco de dados referentes ao Model Gestao que está em Libs
 *
 ...
 *
 */
class Gestao_DAO extends Generic_DAO {

    public $chave = 'id_gestao';
    public $tabela = 'tb_gestao';
