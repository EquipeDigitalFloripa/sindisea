...
/*
    ...
    O abra() e o fecha() vai na página !

	if (window.addEventListener){ //SE não for IE faz isso
	  if(setting.dir=="down"){
        abra();
      }else{
        fecha();
...
var defaultpanel=new ddpanel({
	...
	animate: {enabled: true, steps: 2}, //steps: number of animation steps. Int between 1-20. Smaller=faster.
	pointerimage: {enabled: true, src: ["componente_comum/dropdownpanel/arrow-down.gif", "componente_comum/dropdownpanel/arrow-up.gif"]},
