...
//$base_url="http://tinymce"; //url base of site if you want only relative url leave empty
//$base_url="http://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']; //url base of site if you want only relative url leave empty
$base_url = "http://" . $_SERVER['HTTP_HOST'];  
//$base_url=""; //url base of site if you want only relative url leave empty
$upload_dir = '/sistema/sys/componente_comum/tinymce/plugins/filemanager/source/'; // path from base_url to upload base dir
$current_path = 'source/';
