<?php
require_once('../../../../../Libs/Encripta.class.php');

$post_request = array_merge($_POST, $_REQUEST);

$enc = new Encripta();
if(isset($post_request['ac2'])){
    $ac2 = $enc->md5_decrypt($post_request['ac2']);
}else if(isset ($post_request['ac5'])){
    $ac2 = $post_request['ac5'];
}
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                ...
                <?php if ($upload_files) { ?>
                    <!----- uploader div start ------->
                    <div class="uploader">    
                        <form action="dialog.php?ac2=<?php echo $ac2; ?>" method="post" enctype="multipart/form-data" id="myAwesomeDropzone" class="dropzone">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <?php
                        $link = "dialog.php?ac2=$ac2&type=" . $_GET['type'] . "&editor=";
                        ...
                        <ul class="breadcrumb">
                            ...
                            ?>
                            <li class="pull-right"><a id="refresh" href="dialog.php?ac2=<?php echo $ac2; ?>&type=<?php echo $_GET['type'] ?>&editor=<?php echo $_GET['editor'] ? $_GET['editor'] : 'mce_0'; ?>&subfolder=<?php echo $subfolder ?>&popup=<?php echo $popup; ?>&field_id=<?php echo $_GET['field_id'] ? $_GET['field_id'] : ''; ?>&lang=<?php echo $_GET['lang'] ? $_GET['lang'] : 'en_EN'; ?>&fldr=<?php echo $subdir ?>&<?php echo uniqid() ?>"><i class="icon-refresh"></i></a></li>
                        </ul>
                    </div>
                    <!----- breadcrumb div end ------->
                                            ...
                                            <li>
                                                <figure>
                                                    <a title="<?php echo lang_Open ?>"
                                                       href="dialog.php?ac2=<?php echo $ac2; ?>&type=<?php echo $_GET['type'] ?>&subfolder=<?php echo $subfolder ?>&editor=<?php echo $_GET['editor'] ? $_GET['editor'] : 'mce_0'; ?>&popup=<?php echo $popup; ?>&field_id=<?php echo $_GET['field_id'] ? $_GET['field_id'] : ''; ?>&lang=<?php echo $_GET['lang'] ? $_GET['lang'] : 'en_EN'; ?>&fldr=<?php echo $src ?>&<?php echo uniqid() ?>">
                                                           <?php if ($file == "..") { ?>
