                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?ac5=equipe!@12&type=3&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
                                filetype: 'video',
                                width: 900,
                                height: 600,
                                inline: 1
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?ac5=equipe!@12&type=4&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
                                filetype: 'video',
                                width: 900,
                                height: 600,
                                inline: 1
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?ac5=equipe!@12&type=5&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
                                filetype: 'video',
                                width: 900,
                                height: 600,
                                inline: 1
