...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image:url(temas/<?php echo $tema; ?>/modal/fundo_modal_erro<?php echo $q0; ?>.jpg); background-repeat:no-repeat;">
    <tr>
