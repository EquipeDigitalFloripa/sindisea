...
<head>
	...
	href="/mobile/includes/mobile.css?v=4">
	...
	<div id="escurecedor">
		...
		<div id="area_restrita">
			...
			<form name="form_login" id="form_login" method="post" action=""
				onSubmit="return validar_form_login();">
				...
				<input type="submit" value="Entrar" name="entrar" id="entrar"
					class="botao-entrar" />
				<div class="infos">
					<a href="/perdeu-senha"><div id="perdeu_sua_senha">Perdeu sua
							senha?</div></a>
				</div>
			</form>
				...
				<div class="passo1 step">
					<div class="bloco">
                        ...
                        <div class="texto">Seja bem-vindo ao local de votação.<br>
                            ...
                            Dúvidas / dificuldades: Whatsapp 48 99182-2462</div>
					</div>
