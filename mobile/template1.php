<html>
    ...
    <?php // include('includes/popup.php'); ?>
        <div id="escurecedor">
            ...
            <div id="area_restrita">
                ...
                <form name="form_login" id="form_login" method="post" action=""  onSubmit="return validar_form_login();">
                    ...
                    <div class="infos"><a href="/perdeu-senha"><div id="perdeu_sua_senha">Perdeu sua senha?</div></a></div>
                </form>
        ...
        <section id="a_empresa">
            ...
            <a href="/o-sindisea"><div class="veja_mais">Saiba mais</div></a>
        </section>
        ...
        <section id="redes_sociais">
            ...
            <div class="box_redes">
                <a href="https://www.facebook.com/sindiseasc" target="_blank"><div class="icon_rodape facebook_icon"></div></a>
