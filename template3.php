...
<script src="/scripts/jquery.validate.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            function relogio() {
                ...
                $('#clock').countdown(get5minFromNow(), {elapse: true}).on('update.countdown', function (event) {
                    if (event.elapsed) {
                        $(this).html('00:00');
	...
	<section id="conteudo_2nivel">
		...
		<div class="centraliza_conteudo">
			<div class="passos">
				...
				<div class="passo p3">
					<span class="numero">03</span><br> <span class="texto">Diretoria Executiva</span>
				</div>

				<div class="passo p4">
					<span class="numero">04</span><br> <span class="texto">Conselho Fiscal</span>
				</div>
			...
			<div class="eleicao">
				<div class="passo1 step">
					<div class="bloco">
						...
						<div class="texto">Seja bem-vindo ao local de votação.<br><br>
                            <b>Como votar</b>:<br>
                            ...
                            Dúvidas / dificuldades: Whatsapp 48 99182-2462<br><br></div>
					</div>

					<div class="bloco">
						<form onsubmit="return false;">
							<label for="cpf">CPF*</label> <input type="text" name="cpf"
								class="cpf" /> <label for="cpf">Telefone*</label> <input
								type="text" name="telefone" class="telefone" />
				...
				<div class="passo2 step">
					<div class="bloco" style="border-right: 1px solid black;">
						...
						<form onsubmit="return false;">
							<label for="codigo">Código de verificação*</label> <input
								pattern="[0-9]+$" maxlength="5" minlength="5" type="text"
								name="codigo" class="codigo" />
							<div class="msg_erro"></div>
							<input type="submit" value="CONFIRMAR" class="confirmar"
								onclick="passo(3)" />
						</form>
						...
						<div style="display: none" class="btn_reenvia">
							...
							novo abaixo. <input type="submit" name="reenviar"
								class="reenviar" onclick="passo(2);" value="ENVIAR NOVAMENTE" />
						</div>
				...
				<div class="passo3 step">
					...
					<form onsubmit="return false;">
							...
							<input type="radio" name="voto"
								value="<?php echo $value['id_chapa_eleicao'] ?>"> <span
							...
							class="confirmar" onclick="abrirModal(3)" />
					</form>
				...
				<div class="passo4 step">
					...
					<form onsubmit="return false;">
                            ...
                            <input type="submit" value="VOTAR"
							class="confirmar" onclick="abrirModal(4)" />
					</form>
				...
				<div class="passo5 step">
					...
					<input type="submit" value="FINALIZAR" class="confirmar"
						style="margin-top: 20px;" onclick="window.location.href = '/'" />
	...
	<div class="modal_eleicao">
		<div class="centraliza_conteudo ">
			<div class="conteudo_modal">
				<div class="infos"></div>
				<input type="submit" value="CONFIRMAR SEU VOTO"
					class="botao_eleicao confirmar" /> <input type="submit"
					value="ALTERAR VOTO" class="botao_eleicao voltar"
					onclick="desaparecer('modal_eleicao')" />
			</div>
