<div class="centraliza_conteudo">
    <div class="lado_esquerdo">
        ...
        <div class="box_contato">
            ...
            <div class="fone"><p>(48) 99182 2462</p></div><span>|</span><div class="email"><p>sindiasea@sindiasea.org.br</p></div>
        </div>
        <div class="links_uteis">
            <div class="titulo_links_uteis">LINKS ÚTEIS</div>
            <ul>
                <a href="http://www.sea.sc.gov.br" target="_blank"><li>www.sea.sc.gov.br</li></a>
                <a href="http://www.assea.org.br" target="_blank"><li>www.assea.org.br</li></a>
                <a href="http://www.afipesc.com.br" target="_blank"><li>www.afipesc.com.br</li></a>
                <a href="http://www.portaldoservidor.sc.gov.br" target="_blank"><li>www.portaldoservidor.sc.gov.br</li></a>
            </ul>
        </div>
    </div>
    <div class="lado_direito">
        <a href="/filie-se"><div class="filie_se">Filie-se</div></a>
    </div>
